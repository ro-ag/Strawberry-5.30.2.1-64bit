 ...
 * file: DeviceBitmap.h  */
#ifndef DeviceBitmap_H_
#define DeviceBitmap_H_
#ifndef _APRICOT_H_
#include "apricot.h"
#endif
#include "Drawable.h"
...
typedef struct _DeviceBitmap_vmt {
...
/* methods definition */
	...
	Handle ( *icon)( Handle self);
	Handle ( *image)( Handle self);
} DeviceBitmap_vmt, *PDeviceBitmap_vmt;

extern PDeviceBitmap_vmt CDeviceBitmap;

typedef struct _DeviceBitmap {
/* internal pointers */
	PDeviceBitmap_vmt self;
	PDrawable_vmt super;
	SV  *mate;
...
/* instance variables */
	...
	int type;
} DeviceBitmap, *PDeviceBitmap;

extern void register_DeviceBitmap_Class( void);

/* Local methods definitions */
extern void DeviceBitmap_done( Handle self);
extern void DeviceBitmap_init( Handle self, HV * profile );
extern SV * DeviceBitmap_get_handle( Handle self);
extern Bool DeviceBitmap_begin_paint( Handle self);
extern Bool DeviceBitmap_begin_paint_info( Handle self);
extern void DeviceBitmap_end_paint( Handle self);
extern int DeviceBitmap_get_paint_state( Handle self);
extern int DeviceBitmap_type( Handle self, Bool set, int value);
extern Handle DeviceBitmap_icon( Handle self);
extern Handle DeviceBitmap_image( Handle self);
