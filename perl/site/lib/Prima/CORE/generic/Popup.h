...
/* methods definition */
	...
	Bool ( *autoPopup)( Handle self, Bool set, Bool value);
	void ( *popup)( Handle self, int x ,int y ,int ancLeft ,int ancBottom ,int ancRight ,int ancTop );
} Popup_vmt, *PPopup_vmt;

extern PPopup_vmt CPopup;
...
extern void register_Popup_Class( void);

/* Local methods definitions */
extern void Popup_init( Handle self, HV * profile );
extern SV * Popup_profile_default( Handle self);
extern void Popup_update_sys_handle( Handle self, HV * profile );
extern Bool Popup_selected( Handle self, Bool set, Bool value);
extern Bool Popup_autoPopup( Handle self, Bool set, Bool value);
extern void Popup_popup( Handle self, int x ,int y ,int ancLeft ,int ancBottom ,int ancRight ,int ancTop );
...
#undef  get_autoPopup
#undef  set_autoPopup
#define get_autoPopup(__hs)         autoPopup((__hs),0,(Bool)0)
#define set_autoPopup(__hs,__val)   autoPopup((__hs),1,(__val))
#undef  get_text
#undef  set_text
