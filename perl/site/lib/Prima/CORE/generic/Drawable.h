...
extern int Drawable_fillMode( Handle self, Bool set, int value);
extern SV * Drawable_fillPattern( Handle self, Bool set, SV * value);
extern Point Drawable_fillPatternOffset( Handle self, Bool set, Point value);
...
extern double Drawable_miterLimit( Handle self, Bool set, double value);
...
extern SV * Drawable_get_font_def( Handle self, int first ,int last ,Bool unicode );
...
extern SV * Drawable_render_glyph( Handle self, int index ,HV * profile );
extern SV * Drawable_render_spline( SV * obj ,SV * points ,HV * profile );
extern Bool Drawable_bars( Handle self, SV * rects );
