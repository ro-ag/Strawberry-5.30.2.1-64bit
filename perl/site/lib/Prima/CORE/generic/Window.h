...
/* methods definition */
	...
	SV * ( *effects)( Handle self, Bool set, SV * value);
...
extern void Window_done( Handle self);
...
extern Bool Window_can_propagate_key( Handle self);
...
extern SV * Window_effects( Handle self, Bool set, SV * value);
...
#undef  get_effects
#undef  set_effects
#define get_effects(__hs)         effects((__hs),0,(SV *)0)
#define set_effects(__hs,__val)   effects((__hs),1,(__val))
#undef  get_fillMode
#undef  set_fillMode
