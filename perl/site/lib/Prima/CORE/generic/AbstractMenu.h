...
extern void AbstractMenu_handle_event( Handle self, PEvent event );
extern SV * AbstractMenu_notification_types( Handle self);
...
extern Bool AbstractMenu_autoToggle( Handle self, Bool set, char * varName, Bool value);
extern Bool AbstractMenu_checked( Handle self, Bool set, char * varName, Bool value);
extern Handle AbstractMenu_icon( Handle self, Bool set, char * varName, Handle value);
extern int AbstractMenu_group( Handle self, Bool set, char * varName, int value);
extern SV * AbstractMenu_options( Handle self, Bool set, char * varName, SV * value);
...
extern SV * AbstractMenu_submenu( Handle self, Bool set, char * varName, SV * value);
extern SV * AbstractMenu_text( Handle self, Bool set, char * varName, SV * value);
extern Bool AbstractMenu_execute( Handle self, char * varName );
extern SV * AbstractMenu_find_item_by_key( Handle self, int key );
extern void * AbstractMenu_first_that( Handle self, void * actionProc ,void * params ,Bool useDisabled );
extern SV * AbstractMenu_get_item( Handle self, char * varName ,Bool fullTree );
extern SV * AbstractMenu_get_items( Handle self, char * varName ,Bool fullTree );
extern SV * AbstractMenu_get_children( Handle self, char * varName );
...
extern Bool AbstractMenu_is_custom( Handle self, char * varName );
extern Bool AbstractMenu_is_submenu( Handle self, char * varName );
extern Bool AbstractMenu_is_separator( Handle self, char * varName );
...
extern void * AbstractMenu_new_menu( Handle self, SV * sv ,int level ,void * avt );
...
#define get_autoToggle(__hs,__var1)         autoToggle((__hs),0,(__var1),(Bool)0)
#define set_autoToggle(__hs,__var1,__val)   autoToggle((__hs),1,(__var1),(__val))
#undef  get_checked
#undef  set_checked
...
#undef  get_submenu
#undef  set_submenu
#define get_submenu(__hs,__var1)         submenu((__hs),0,(__var1),(SV *)0)
#define set_submenu(__hs,__var1,__val)   submenu((__hs),1,(__var1),(__val))
#undef  get_icon
#undef  set_icon
#define get_icon(__hs,__var1)         icon((__hs),0,(__var1),(Handle)0)
#define set_icon(__hs,__var1,__val)   icon((__hs),1,(__var1),(__val))
#undef  get_owner
#undef  set_owner
...
#undef  get_group
#undef  set_group
#define get_group(__hs,__var1)         group((__hs),0,(__var1),(int)0)
#define set_group(__hs,__var1,__val)   group((__hs),1,(__var1),(__val))
#undef  get_eventFlag
#undef  set_eventFlag
...
#undef  get_options
#undef  set_options
#define get_options(__hs,__var1)         options((__hs),0,(__var1),(SV *)0)
#define set_options(__hs,__var1,__val)   options((__hs),1,(__var1),(__val))
